    ...
    return (
        <Navbar bg="dark">
          <Nav className="justify-content-start">
            ...
            <Nav.Item>
              <Nav.Link href="/userlist" className="gray mx-3">Customers</Nav.Link>
            </Nav.Item>
            <Nav.Item>
              <Nav.Link href="/orderlist" className="gray mx-3">Orders</Nav.Link>
            </Nav.Item>
          </Nav>
          <Nav className="ms-auto">
            <Nav.Link href='/addOrder' className="gray mx-3">Add Order</Nav.Link>
